    ...
    >
      <b-col style="padding: 30px !important;">
        <p class="zen-text">
          ...
          ZEN Exchange operates on top of Binance Cloud’s trading and security infrastructure. The functionality of ZCX is analogous to that of BNB on Binance.<br><br>
